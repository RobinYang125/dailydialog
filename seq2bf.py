...
class DataLoader(object):
    ...
    def get_batch_data(self):
        ...
        return np.asarray(self.pad_sentence(x_batch, np.amax(x_length))), \
               np.asarray(x_length), \
               np.asarray(self.eos_pad(y_backward, y_backward_max_length)), \
               np.asarray(self.pad_sentence(self.add_split_word(y_backward, y_split_word), y_backward_max_length)), \
